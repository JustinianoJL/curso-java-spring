package com.curso.java.oo.spring;
...
public class Ejercicio01SpringWeb extends HttpServlet
{
	...
	private void asignarDatosEnProfesor(Profesor p, String nombre, String ap1, String ap2, String dni, String dir, String fdn, String dep, boolean ml)
	{
		p.setNombre(nombre);
		p.setApellido1(ap1);
		p.setApellido2(ap2);
